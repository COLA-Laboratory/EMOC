...
namespace emoc {
	...
	void SA::Crossover(Individual **parent_pop, Individual **offspring_pop)
	{
	...
	void SA::SetDistanceInfo(std::vector<DistanceInfo> &distanceinfo_vec, int target_index, double distance)
	{
	...
	int SA::CrowdingDistance(Individual **mixed_pop,  int pop_num, int *pop_sort, int rank_index)
	{
		int num_in_rank = 0;
	...
	void SA::EnvironmentalSelection(Individual **parent_pop, Individual **mixed_pop)
	{
