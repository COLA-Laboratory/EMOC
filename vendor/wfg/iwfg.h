...
//int m_greaterabbrevorder(const POINT &v1, const POINT& v2);
//int m_greaterabbrev(const POINT& v1, const POINT& v2);
//int m_greaterorder(const POINT& v1, const POINT& v2);
//int m_greater(const POINT& v1, const POINT& v2);
//int m_sorter(const int& a, const int& b);
