...
//	if(TEST_CPP)
//		std::sort(&ps.points[i_safe], &ps.points[i_safe] + ps.nPoints - i_safe, m_greater);
//	else
...
//	if(TEST_CPP)
//		std::sort(ps.points, ps.points + i_safe, m_greaterabbrev);
//	else
...
//
//	if(TEST_CPP)
//		std::sort(sorder, sorder+nPoints, m_sorter);
//	else
...
//
//		if(TEST_CPP)
//			std::sort(stacks[i][1].front.points, stacks[i][1].front.points + stacks[i][1].front.nPoints, m_greaterabbrevorder);
//		else
...
//		
//		if (TEST_CPP)
//			std::sort(fsorted[i].points, fsorted[i].points + ps.nPoints, m_greaterorder);
//		else
...
//
//	if(TEST_CPP)
//		std::sort(ps.points, ps.points + ps.nPoints, m_greater);
//	else
