...
def pbo_trial(
    ...
    if problem == 'mop':
        script_dir, _ = os.path.split(os.path.dirname(__file__))
        results_folder = (
            script_dir + "/experiments/results/" + problem + "/" + algo_id + "/"
        )
    else:
    ...
    if restart:
        ...
        try:
            ...
            # Historical objective values at the maximum of the posterior mean
            max_post_mean_func,obj_val_at_max_post_mean = compute_obj_val_at_max_post_mean(
        ...
        obj_vals_at_max_post_mean = [obj_val_at_max_post_mean]
        # print(obj_val_at_max_post_mean)

        # Historical maximum objective values within queries and runtimes
        max_obj_val_within_queries = obj_vals.max().item()
        max_obj_vals_within_queries = [max_obj_val_within_queries]
        # print(max_obj_val_within_queries)
...
def compute_obj_val_at_max_post_mean(
    ...
    # print("max post mean func", max_post_mean_func)
    # print(obj_func(max_post_mean_func))
    obj_val_at_max_post_mean_func = obj_func(max_post_mean_func).item()
    return max_post_mean_func, obj_val_at_max_post_mean_func
